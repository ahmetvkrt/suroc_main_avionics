...
float q[4];
uint8_t IMU_data[8] = {0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08}; //���ڴ��IMU�������̬��
...
void change_to_int16(float BNO080_Pitch, float BNO080_Roll, float BNO080_Yaw)
{
	...
	IMU_data[0] = (uint8_t)(pitch_100 >> 8 & 0xFF); //��λ
	IMU_data[1] = (uint8_t)(pitch_100 & 0xFF);
	IMU_data[2] = (uint8_t)(roll_100 >> 8 & 0xFF); //��λ
	IMU_data[3] = (uint8_t)(roll_100 & 0xFF);
	IMU_data[4] = (uint8_t)(yaw_100 >> 8 & 0xFF); //��λ
    ...
    switch (value.sensorId) {
        ...
        case SH2_ROTATION_VECTOR: //������̬�ں�
            ...
            printf("%8.4f Rotation Vector: "
                   ...
                   BNO080_Pitch, BNO080_Roll, BNO080_Yaw);*/
            break;
        case SH2_GAME_ROTATION_VECTOR: //��ʼʱYAWΪ0
            /*r = value.un.gameRotationVector.real;
            i = value.un.gameRotationVector.i;
            j = value.un.gameRotationVector.j;
            k = value.un.gameRotationVector.k;
...
void BNO085_init(void)
{
    ...
    printf("Step 1: Creating HAL instance...\r\n");
#endif
...
#ifdef DEBUG_MODE
    printf("Step 2: HAL instance created.\r\n");
    printf("Step 3: Opening SH2 interface...\r\n");
#endif
...
#ifdef DEBUG_MODE
    printf("Step 4: sh2_open returned with status: %d\r\n", status);
    if (status != SH2_OK) {
        printf("ERROR: sh2_open failed! Status: %d\r\n", status);
        printf("SH2_OK = %d\r\n", SH2_OK);
        return; // Exit early if open failed
    }
    printf("Step 5: SH2 interface opened successfully.\r\n");
#endif
...
#ifdef DEBUG_MODE
    printf("Step 6: Sensor callback registered.\r\n");
#endif
    ...
    printf("Step 7: Reading product IDs...\r\n");
    reportProdIds();
    printf("Step 8: Product IDs read complete.\r\n");
#endif
...
#ifdef DEBUG_MODE
    printf("Step 9: Starting sensor reports...\r\n");
#endif
...
#ifdef DEBUG_MODE
    printf("Step 10: BNO085_init() completed successfully!\r\n");
#endif
}
